...
public class RedisCacheWriterPlus implements RedisCacheWriter {
     ...
     */
    public RedisCacheWriterPlus(RedisConnectionFactory connectionFactory) {
     ...
     *                          to disable locking.
     */
    public RedisCacheWriterPlus(RedisConnectionFactory connectionFactory, Duration sleepTime) {
