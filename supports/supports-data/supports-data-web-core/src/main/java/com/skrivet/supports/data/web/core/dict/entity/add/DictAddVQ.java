package com.skrivet.supports.data.web.core.dict.entity.add;
...
public class DictAddVQ extends BasicEntity {
    ...
    @ApiModelProperty(value = "字典备注信息", example = "这个字典干XX用的",required = true)
